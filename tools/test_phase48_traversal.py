...
def main():
    ...
    # temporary traversal scaffolds while missing dynamic mechanics/death exist.
    ...
    assert ROOM09_PROPERTIES[5] == 3      # scaffold code 6 -> property 3
    ...
    # Original central climb column remains at x15 and joins the debug bridge.
    ...
    print('OK: Phase 48 Room01/02/09 traversal scaffolds + exact Room09 route + visible footer + down-motion gate')
