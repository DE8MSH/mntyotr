...
; Unified C64 -> PCE palette. PCE raw CRAM words are GGGRRRBBB. The C64 RGB
; reference is quantized once to 3 bits/channel, so rooms/decor/mechanisms all
; use the same colour for a given C64 colour index.
room00_bg_palettes:
        ; 0 background black $00
